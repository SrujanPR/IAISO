...
export const CircularTestimonials = ({
  ...
  const colorArrowHoverBg = colors.arrowHoverBackground ?? "#f58a1f";
  ...
  return (
    <div className="w-full max-w-5xl p-6 sm:p-8">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex gap-6 pt-12 md:pt-0">
            <button
              ...
              type="button"
            >
              <ChevronLeft className="h-5 w-5" style={{ color: colorArrowFg }} />
            </button>
            ...
            <button
              ...
              type="button"
            >
              <ChevronRight className="h-5 w-5" style={{ color: colorArrowFg }} />
            </button>
          </div>
        </div>
      </div>
