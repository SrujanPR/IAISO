...
import { Megaphone, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react'; 
gsap.registerPlugin(ScrollTrigger);

const MarketingProfessionalsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Marketing Professionals</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Driven Marketing Strategy and Customer Analytics
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into campaign optimization, customer insights, and personalized marketing for data-driven growth
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Marketing Professionals program transforms marketing strategy by integrating artificial intelligence into customer analytics, campaign optimization, and content personalization. As consumer behavior becomes increasingly digital, marketers must master AI-driven audience segmentation, predictive customer insights, and automated marketing systems.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional marketing principles with modern AI capabilities, preparing professionals to lead in intelligent marketing systems, data-driven brand management, and personalized customer engagement at scale.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Marketing Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core marketing capability—embedded within research, strategy, content, and customer engagement—while preserving creative excellence, brand integrity, and ethical marketing practices.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-enhanced marketing, intelligent customer engagement, and data-driven brand strategy"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate marketing excellence, global relevance, and real-world engagement readiness into modern AI and marketing programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in marketing AI, customer analytics, and digital engagement</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on creative excellence, brand strategy, and ethical AI deployment in marketing</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for marketing strategies, campaign frameworks, or brand innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Marketing-first architecture preserving brand principles, customer-centricity, and creative standards</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, professional development, or integrated marketing program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Employability & Engagement Readiness</h3>
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-marketing portfolios and customer analytics experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on creative skills, analytical capabilities, and ethical marketing responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                ...
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled marketing</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Marketing</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered marketing professionals</p>
...
export default MarketingProfessionalsPage;
