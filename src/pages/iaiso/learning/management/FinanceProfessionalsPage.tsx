...
import { DollarSign, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap, } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const FinanceProfessionalsPage = () => {
      ...
      if (cardsRef.current) {
        ...
        gsap.fromTo(
          ...
          { opacity: 0, y: 40 },
          {
            ...
            duration: 0.8,
            stagger: 0.15,
            ease: 'power3.out', clearProps: 'transform', scrollTrigger: {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Enhanced Financial Management and Analytics
            </p>

            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into financial planning, risk management, and
              investment analysis for data-driven financial decision-making
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Finance Professionals program transforms financial management by integrating artificial intelligence into financial planning, risk assessment, and investment decision-making. As financial markets become increasingly complex, professionals must master AI-driven predictive analytics, algorithmic trading, and intelligent risk modeling.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional finance principles with modern AI capabilities, preparing professionals to lead in intelligent financial systems, automated analytics, and data-driven wealth management.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Finance Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core finance capability—embedded within analysis, forecasting, risk management, and investment strategy—while preserving financial principles, regulatory compliance, and ethical standards.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-enhanced finance, intelligent analytics, and strategic financial management"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable finance professionals to design, build, and deploy AI-powered financial systems and analytics' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in AI-driven forecasting, risk modeling, and intelligent investment analysis' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Finance Rigor', desc: 'Strengthen understanding of evidence-based, compliant, and ethically-sound AI-enabled finance' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around financial data, algorithmic transparency, and responsible AI in finance' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in financial analysis, investment management, and fintech innovation' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between finance practice and cutting-edge AI-enabled financial technology' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate finance excellence, global relevance, and real-world analytical readiness into modern AI and financial programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in fintech, financial AI, and investment analytics</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on financial excellence, regulatory compliance, and ethical AI deployment in finance</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for investment strategies, risk frameworks, or financial innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Finance-first architecture preserving financial principles, regulatory standards, and investment methodologies</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, professional development, or integrated finance program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Employability & Analytical Readiness</h3>
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-finance portfolios and financial analytics experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on financial depth, analytical skills, and ethical professional responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Case-based learning integrated with financial analytics platforms and investment simulation workshops</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Finance Professionals (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a management–AI integration program</p>
                <p>Validates advanced competence in AI-powered financial analytics, risk management, and investment strategy</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled finance</p>
              </div>
            </div>
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                ...
                <p>Designed to deliver high value through globally relevant credentials and analytics-aligned learning outcomes</p>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Finance Professionals Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms finance practice into a future-ready discipline centered on AI-enhanced analytics', 'Expands career pathways into financial analysis, investment management, fintech innovation, and risk consulting', 'Strengthens readiness for finance leadership roles in AI-first and technology-enabled financial organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated finance education and fintech innovation', 'Encourages collaboration across Finance, Economics, Data Science, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Finance</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered finance professionals</p>
...
export default FinanceProfessionalsPage;
