      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-3xl mx-auto mb-8">Executive learning integrated with business simulations and strategic leadership workshops</p>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-2xl mx-auto">Business Leaders Academic and Professional Advantage</p>
          </div>
