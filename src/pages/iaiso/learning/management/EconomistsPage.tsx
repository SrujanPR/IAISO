...
import { LineChart, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react'; 
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Economists</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Enhanced Economic Analysis and Policy Intelligence
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into economic modeling, policy analysis, and predictive forecasting for data-driven economic insights
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Economists program transforms economic analysis by integrating artificial intelligence into economic modeling, policy evaluation, and market forecasting. As economies become increasingly complex and data-rich, economists must master AI-driven econometric modeling, automated data analysis, and intelligent policy simulation.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional economic theory with modern AI capabilities, preparing professionals to lead in computational economics, intelligent policy analysis, and the future of data-driven economic governance.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Economic Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core economic capability—embedded within research, analysis, forecasting, and policy development—while preserving economic rigor, theoretical foundations, and evidence-based standards.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-enhanced economics, intelligent policy analysis, and data-driven economic research"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable economists to design, build, and deploy AI-powered economic models and analysis systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in AI-driven econometrics, predictive modeling, and intelligent policy analysis' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Economic Rigor', desc: 'Strengthen understanding of theory-based, empirically-grounded, and methodologically-sound AI-enabled economics' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around data privacy, algorithmic bias, and responsible AI in economic policy' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in economic research, policy analysis, and financial forecasting' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between economic theory and cutting-edge AI-enabled computational economics' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate economic excellence, global relevance, and real-world policy readiness into modern AI and economics programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in computational economics, policy AI, and economic forecasting</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on analytical excellence, theoretical rigor, and ethical AI deployment in economics</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for economic models, policy frameworks, or research innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Economics-first architecture preserving theoretical foundations, empirical standards, and methodological rigor</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, research pathway, or integrated economics program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Employability & Policy Readiness</h3>
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-economics portfolios and policy analytics experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on economic depth, analytical skills, and ethical research responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Research-based learning integrated with economic data platforms and policy simulation workshops</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Economists (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a management–AI integration program</p>
                <p>Validates advanced competence in AI-powered economic analysis, policy modeling, and forecasting</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled economics</p>
              </div>
            </div>
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                ...
                <p>Designed to deliver high value through globally relevant credentials and policy-aligned learning outcomes</p>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Economists Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms economic practice into a future-ready discipline centered on AI-enhanced analysis', 'Expands career pathways into economic research, policy analysis, financial forecasting, and consulting', 'Strengthens readiness for economics leadership roles in AI-first and technology-enabled organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated economics education and computational policy innovation', 'Encourages collaboration across Economics, Finance, Public Policy, Data Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Economics</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered economists</p>
