...
import { Rocket, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react'; 
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Entrepreneurs</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Enabled Venture Creation and Innovation Leadership
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into startup strategy, product development, and scalable growth for entrepreneurial success
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Entrepreneurs program transforms venture creation by integrating artificial intelligence into business model innovation, product development, and growth hacking. As startups face increasingly competitive markets, entrepreneurs must master AI-driven market analysis, automated customer acquisition, and intelligent product iteration.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional entrepreneurship principles with modern AI capabilities, preparing founders to build AI-native businesses, leverage intelligent automation, and create scalable ventures in the digital economy.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Entrepreneurial Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core entrepreneurial capability—embedded within ideation, validation, scaling, and optimization—while preserving innovation mindset, customer obsession, and ethical business building.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-native venture creation, intelligent innovation, and scalable entrepreneurship"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable entrepreneurs to design, build, and deploy AI-powered business models and product systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in AI-driven market analysis, automated growth, and intelligent product development' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Entrepreneurial Rigor', desc: 'Strengthen understanding of evidence-based, customer-validated, and ethically-sound AI-enabled ventures' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around data privacy, algorithmic fairness, and responsible AI in business' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles as AI-native founders, venture leaders, and innovation entrepreneurs' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between entrepreneurship and cutting-edge AI-enabled venture building' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate entrepreneurial excellence, global relevance, and real-world venture readiness into modern AI and startup programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in AI entrepreneurship, venture building, and startup innovation</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on innovation excellence, customer validation, and ethical AI deployment in ventures</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for business models, product strategies, or venture innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Entrepreneurship-first architecture preserving lean startup principles, customer development, and innovation methodologies</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, incubator program, or integrated entrepreneurship curriculum</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Employability & Venture Readiness</h3>
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-entrepreneurship portfolios and venture building experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on innovation skills, business acumen, and ethical entrepreneurship responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Hands-on learning integrated with startup incubators and venture simulation workshops</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Entrepreneurs (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a management–AI integration program</p>
                <p>Validates advanced competence in AI-powered venture creation, intelligent innovation, and scalable entrepreneurship</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled ventures</p>
              </div>
            </div>
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                ...
                <p>Designed to deliver high value through globally relevant credentials and venture-aligned learning outcomes</p>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Entrepreneurs Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms entrepreneurship into a future-ready discipline centered on AI-enhanced venture creation', 'Expands career pathways into AI-native startups, venture leadership, innovation consulting, and growth roles', 'Strengthens readiness for founder and leadership roles in AI-first and technology-driven ventures'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated entrepreneurship education and venture innovation', 'Encourages collaboration across Entrepreneurship, Innovation, Computer Science, Design, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Entrepreneurship</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered entrepreneurs</p>
