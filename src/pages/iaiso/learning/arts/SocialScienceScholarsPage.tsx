...
import { Users2, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const SocialScienceScholarsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Social Science Scholars</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in Computational Social Science and AI-Assisted Research
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into sociological research, behavioral analysis, and social data science for societal insights
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Social Science Scholars program transforms social research by integrating artificial intelligence into sociological analysis, behavioral modeling, and policy evaluation. As social phenomena become increasingly data-rich and complex, scholars must master AI-driven social network analysis, sentiment mining, and predictive modeling.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical social theory with modern AI capabilities, preparing scholars to lead in computational social science, data-driven policy, and the future of societal research.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core social science capability—embedded within survey research, ethnography, policy analysis, and social modeling—while preserving theoretical frameworks, methodological rigor, and ethical research practices.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven social research, computational sociology, policy analytics, and behavioral science"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable social science scholars to design, build, and deploy AI-powered social research and analysis systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in social network analysis, sentiment analysis, and behavioral modeling' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Social Rigor', desc: 'Strengthen understanding of theory-informed, methodologically-sound, and ethically-aware AI-enabled social science' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around privacy, bias, and responsible AI in social research' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in research, policy, government, NGOs, and data science' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Research Readiness', desc: 'Bridge the gap between social theory and cutting-edge practice in AI-enabled social research' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scholarly excellence, global relevance, and real-world research readiness into modern AI and social science programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in computational social science, social analytics, and AI frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on methodological rigor, theoretical depth, and ethical AI deployment in social research</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for peer-reviewed publication, policy reports, or social impact projects</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Social science-first architecture preserving sociological theory, research methods, and critical analysis principles</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, honours pathway, or integrated social science program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-social science portfolios and computational research experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on social theory depth, data skills, and ethical scholarly responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Research-based learning integrated with social science labs and data analysis studios</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Social Science and Computational Research (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a humanities–AI integration program</p>
                <p>Validates advanced competence in AI-powered social research, computational sociology, and policy analytics</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled social science</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Social Science Scholars Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms social science into a future-ready discipline centered on AI-assisted social research', 'Expands career pathways into research, policy, government, NGOs, data science, and consulting', 'Strengthens readiness for scholarly roles in AI-first and data-intensive social research organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated social science and computational research education', 'Encourages collaboration across Sociology, Political Science, Economics, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Social Science</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered social science scholars</p>
...
export default SocialScienceScholarsPage;
