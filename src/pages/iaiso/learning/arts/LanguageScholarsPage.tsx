...
import { Languages, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const LanguageScholarsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Language Scholars</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in Computational Linguistics and AI Language Technologies
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into linguistic analysis, translation, and natural language processing for advanced language research
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Language Scholars program transforms linguistic research by integrating artificial intelligence into language analysis, translation, and natural language understanding. As language data becomes digitized and multilingual communication expands, scholars must master AI-driven text processing, machine translation, and computational linguistics.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical linguistics with modern AI capabilities, preparing scholars to lead in language technology, multilingual AI systems, and the future of human-computer language interaction.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core linguistic capability—embedded within language analysis, translation, speech processing, and language education—while preserving linguistic theory, cultural sensitivity, and ethical language technology.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven linguistics, computational language analysis, translation technology, and language education"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable language scholars to design, build, and deploy AI-powered language and translation systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in NLP, machine translation, and language technology' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Linguistic Rigor', desc: 'Strengthen understanding of evidence-based, culturally-aware, and ethical AI-enabled linguistics' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around language preservation, cultural bias, and responsible AI' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in translation, localization, language tech, and education' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Research Readiness', desc: 'Bridge the gap between linguistic theory and cutting-edge practice in AI-enabled language research' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scholarly excellence, global relevance, and real-world research readiness into modern AI and linguistics programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in computational linguistics, NLP, and AI frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on multilingual competence, cultural sensitivity, and ethical AI deployment</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for peer-reviewed publication, language technology projects, or cultural applications</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Linguistics-first architecture preserving phonology, syntax, semantics, and sociolinguistics principles</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, honours pathway, or integrated linguistics program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-linguistics portfolios and language technology experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on linguistic depth, computational skills, and ethical scholarly responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Research-based learning integrated with language labs and NLP studios</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Linguistics and Language Technology (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a humanities–AI integration program</p>
                <p>Validates advanced competence in AI-powered linguistics, NLP, and language technology</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled language research</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Language Scholars Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms linguistic research into a future-ready discipline centered on AI-assisted language analysis', 'Expands career pathways into translation, localization, language tech, and computational linguistics', 'Strengthens readiness for scholarly roles in AI-first and language technology organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated linguistics and language technology education', 'Encourages collaboration across Linguistics, Computer Science, Translation Studies, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Linguistics</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered language scholars</p>
...
export default LanguageScholarsPage;
