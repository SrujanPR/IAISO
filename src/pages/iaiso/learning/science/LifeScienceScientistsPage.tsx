...
const LifeScienceScientistsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Life Science Scientists</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in Computational Biology and AI-Driven Bioinformatics
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into biological research, genomic analysis, and cellular modeling for breakthrough life science discoveries
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Life Science Scientists program transforms biological research by integrating artificial intelligence into genomics, proteomics, and cellular analysis. As life sciences generate unprecedented data volumes, scientists must master AI-driven bioinformatics, pattern recognition in biological systems, and predictive modeling of cellular processes.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical biology with modern AI capabilities, preparing scientists to lead in computational biology, drug discovery, personalized medicine, and synthetic biology.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core scientific capability—embedded within molecular biology, genetics, biochemistry, and systems biology—while preserving scientific rigor, experimental validation, and biological principles.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven bioinformatics, computational biology, drug discovery, and life science research"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable life scientists to design, build, and deploy AI-powered bioinformatics and biological analysis systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in intelligent genomic analysis, protein modeling, and systems biology' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Scientific Rigor', desc: 'Strengthen understanding of reproducible, validated, and peer-reviewable AI-enabled biological research' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around genetic privacy, responsible AI, and bioethical standards' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in pharma, biotech, research institutions, and healthcare' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Research Readiness', desc: 'Bridge the gap between academic knowledge and cutting-edge research in AI-enabled life sciences' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scientific rigor, global relevance, and real-world research readiness into modern AI and computational biology programs.</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in bioinformatics, systems biology, and AI frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on reproducibility, open science, and ethical AI deployment in biological research</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Science-first architecture preserving biology fundamentals, genetics, and molecular principles</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-biology research portfolios and bioinformatics analysis experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on biology depth, computational skills, and ethical scientific responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Life Sciences and Bioinformatics (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a science–AI integration program</p>
                <p>Validates advanced competence in AI-powered biological research, genomics, and computational biology</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled life sciences</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Biology Students Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms life science research into a future-ready discipline centered on AI-driven biological discovery', 'Expands career pathways into biotech, pharma, genomics, computational biology, and healthcare', 'Strengthens readiness for global research roles in AI-first and data-intensive life science organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated life sciences and computational biology education', 'Encourages collaboration across Biology, Chemistry, Medicine, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Life Sciences</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered life science scientists</p>
...
export default LifeScienceScientistsPage;
