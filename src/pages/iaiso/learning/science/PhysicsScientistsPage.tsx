...
import { Atom, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const PhysicsScientistsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Physics Scientists</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in Computational Physics and AI-Driven Discovery
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into physical modeling, simulation, and data analysis for breakthrough scientific discoveries
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Physics Scientists program transforms physics research by integrating artificial intelligence into computational modeling, experimental data analysis, and theoretical discovery. As scientific challenges become more complex, physicists must master AI-driven simulation, pattern recognition in big data, and automated hypothesis generation.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical physics with modern AI capabilities, preparing scientists to lead in computational physics, particle discovery, materials simulation, and quantum research.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core scientific capability—embedded within theoretical modeling, experimental design, data analysis, and simulation—while preserving scientific rigor, reproducibility, and theoretical foundations.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven physics research, computational modeling, scientific discovery, and data-intensive experimentation"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable physics scientists to design, build, and deploy AI-powered models and simulation systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in intelligent data analysis, pattern recognition, and predictive modeling' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Scientific Rigor', desc: 'Strengthen understanding of reproducible, validated, and peer-reviewable AI-enabled research' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around data integrity, responsible AI, and transparent scientific practice' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in research institutions, national labs, and tech industries' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Research Readiness', desc: 'Bridge the gap between academic knowledge and cutting-edge research requirements for AI-enabled physics' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scientific rigor, global relevance, and real-world research readiness into modern AI and computational physics programs.</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in computational physics, scientific computing, and AI frameworks</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Science-first architecture preserving physics fundamentals, mathematical rigor, and theoretical depth</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-physics research portfolios and computational modeling experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on physics depth, computational skills, and ethical scientific responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Physics and Scientific Computing (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a science–AI integration program</p>
                <p>Validates advanced competence in AI-powered physics research, computational modeling, and data analysis</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled physics</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Physics Students Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms physics research into a future-ready discipline centered on AI-driven discovery', 'Expands career pathways into computational physics, data science, research institutions, and tech industries', 'Strengthens readiness for global research roles in AI-first and data-intensive scientific organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated physics and computational science education', 'Encourages collaboration across Physics, Mathematics, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Physics</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered physics scientists</p>
...
export default PhysicsScientistsPage;
