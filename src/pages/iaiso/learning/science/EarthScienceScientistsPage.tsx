...
const EarthScienceScientistsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Earth Science Scientists</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in Geospatial Intelligence and Planetary Analysis
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into geological modeling, climate systems, and planetary research for sustainable Earth management
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Earth Science Scientists program transforms geoscience research by integrating artificial intelligence into geological modeling, climate prediction, and remote sensing analysis. As Earth systems become increasingly complex, scientists must master AI-driven geospatial analytics, predictive modeling of natural hazards, and planetary data interpretation.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical geology and geophysics with modern AI capabilities, preparing scientists to lead in climate research, natural resource management, disaster prediction, and planetary exploration.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core scientific capability—embedded within geospatial analysis, seismology, meteorology, and oceanography—while preserving scientific rigor, field validation, and Earth system principles.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven geoscience research, climate modeling, natural hazard prediction, and planetary exploration"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable Earth scientists to design, build, and deploy AI-powered geospatial and climate modeling systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in intelligent remote sensing, geological prediction, and climate analytics' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Scientific Rigor', desc: 'Strengthen understanding of reproducible, validated, and peer-reviewable AI-enabled geoscience research' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around environmental impact, responsible AI, and sustainable Earth stewardship' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in climate research, energy, environmental consulting, and space agencies' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Research Readiness', desc: 'Bridge the gap between academic knowledge and cutting-edge research in AI-enabled Earth sciences' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scientific rigor, global relevance, and real-world research readiness into modern AI and geoscience programs.</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in geoscience, remote sensing, climate science, and AI frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on reproducibility, open science, and ethical AI deployment in Earth system research</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Science-first architecture preserving geoscience fundamentals, geology, geophysics, and climatology principles</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-geoscience research portfolios and geospatial analysis experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on Earth science depth, computational skills, and ethical scientific responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-secondary/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto mb-8">Research-based learning integrated with computational labs and geospatial analysis studios</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <div className="space-y-3 text-sm text-gray-text">
                <p>Awarded as <strong>Certified Specialist in AI for Earth Sciences and Geospatial Intelligence (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a science–AI integration program</p>
                <p>Validates advanced competence in AI-powered geoscience research, remote sensing, and climate modeling</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled Earth sciences</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-2xl mx-auto">Earth Science Students Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Transforms Earth science research into a future-ready discipline centered on AI-driven planetary analysis', 'Expands career pathways into climate research, energy, environmental consulting, disaster management, and space agencies', 'Strengthens readiness for global research roles in AI-first and data-intensive geoscience organizations'].map((item, idx) => (
            ...
            <div className="bg-secondary/30 rounded-2xl p-8 shadow-lg border border-border">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated geoscience and climate education', 'Encourages collaboration across Geology, Meteorology, Oceanography, Geography, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Earth Sciences</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered Earth science scientists</p>
...
export default EarthScienceScientistsPage;
