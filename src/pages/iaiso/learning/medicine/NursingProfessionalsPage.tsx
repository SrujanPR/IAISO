...
import { HeartPulse, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react'; 
gsap.registerPlugin(ScrollTrigger);

const NursingProfessionalsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Nursing Professionals</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Enhanced Patient Care and Nursing Informatics
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into nursing practice, patient monitoring, and care coordination for enhanced healthcare delivery
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Nursing Professionals program transforms nursing practice by integrating artificial intelligence into patient monitoring, care coordination, and clinical workflows. As healthcare becomes increasingly technology-enabled, nurses must master AI-driven patient assessment tools, intelligent monitoring systems, and predictive care analytics.</p>
                <p className="text-gray-text leading-relaxed">This program bridges compassionate nursing care with modern AI capabilities, preparing professionals to lead in smart healthcare environments, AI-assisted patient care, and the future of intelligent nursing practice.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Nursing Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core nursing capability—embedded within patient assessment, care planning, medication management, and health education—while preserving nursing ethics, compassionate care, and clinical judgment.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-enhanced nursing, intelligent patient care, and nursing informatics"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable nursing professionals to design, build, and deploy AI-powered patient monitoring and care systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in AI-assisted assessment, care coordination, and patient education' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Clinical Rigor', desc: 'Strengthen understanding of evidence-based, patient-centered, and ethically-sound AI-enabled nursing' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around patient dignity, data privacy, and responsible AI in nursing care' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in clinical nursing, care coordination, and health informatics' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between nursing practice and cutting-edge technology in AI-enabled healthcare' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate clinical excellence, global relevance, and real-world practice readiness into modern AI and nursing programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in nursing informatics, AI healthcare, and patient care technology</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on clinical excellence, compassionate care, and ethical AI deployment in nursing</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for care protocols, nursing research, or healthcare innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Nursing-first architecture preserving patient care, clinical practice, and evidence-based principles</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, professional development, or integrated nursing program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-nursing portfolios and intelligent care technology experience</span></li>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-3xl mx-auto mb-8">Clinical-based learning integrated with nursing labs and healthcare technology studios</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Awarded as <strong>Certified Specialist in AI for Nursing Professionals (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a medicine–AI integration program</p>
                <p>Validates advanced competence in AI-powered nursing practice, patient care technology, and nursing informatics</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled nursing</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-2xl mx-auto">Nursing Professionals Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Transforms nursing practice into a future-ready discipline centered on AI-enhanced patient care', 'Expands career pathways into clinical nursing, care coordination, nursing informatics, and healthcare technology', 'Strengthens readiness for professional roles in AI-first and technology-enabled healthcare environments'].map((item, idx) => (
            ...
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated nursing education and patient care technology', 'Encourages collaboration across Nursing, Medicine, Health Informatics, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Nursing</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered nursing professionals</p>
...
export default NursingProfessionalsPage;
