...
import { Pill, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react'; 
gsap.registerPlugin(ScrollTrigger);

const PharmaceuticalScientistsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Pharmaceutical Scientists</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Driven Drug Discovery and Pharmaceutical Research
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into drug development, clinical trials, and precision medicine for accelerated therapeutic innovation
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Pharmaceutical Scientists program transforms drug discovery and development by integrating artificial intelligence into molecular design, clinical trial optimization, and pharmacovigilance. As the pharmaceutical industry embraces digital transformation, scientists must master AI-driven drug screening, predictive modeling, and personalized medicine approaches.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional pharmaceutical science with modern AI capabilities, preparing scientists to lead in computational drug discovery, intelligent clinical trials, and the future of precision therapeutics.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Pharmaceutical Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core pharmaceutical capability—embedded within drug discovery, development, manufacturing, and safety monitoring—while preserving scientific rigor, regulatory compliance, and patient safety.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven drug discovery, pharmaceutical research, and precision medicine development"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable pharmaceutical scientists to design, build, and deploy AI-powered drug discovery and development systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in molecular modeling, clinical trial AI, and pharmacovigilance analytics' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Scientific Rigor', desc: 'Strengthen understanding of evidence-based, regulatory-compliant, and ethically-sound AI-enabled pharmaceutical science' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around patient safety, data integrity, and responsible AI in drug development' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in pharma R&D, biotech, clinical research, and regulatory science' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between pharmaceutical science and cutting-edge AI-enabled drug discovery' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate scientific excellence, global relevance, and real-world research readiness into modern AI and pharmaceutical programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in AI drug discovery, pharmaceutical informatics, and regulatory frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on scientific excellence, regulatory compliance, and ethical AI deployment in pharma</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for drug discovery research, clinical protocols, or regulatory submissions</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Pharmaceutical-first architecture preserving drug discovery principles, research methods, and regulatory standards</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, honours pathway, or integrated pharma program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-pharma portfolios and drug discovery experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on scientific depth, technical skills, and ethical professional responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-3xl mx-auto mb-8">Research-based learning integrated with pharmaceutical labs and computational chemistry studios</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Awarded as <strong>Certified Specialist in AI for Pharmaceutical Scientists (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a medicine–AI integration program</p>
                <p>Validates advanced competence in AI-powered drug discovery, pharmaceutical research, and clinical trial optimization</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled pharmaceutical science</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-2xl mx-auto">Pharmaceutical Scientists Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Transforms pharmaceutical science into a future-ready discipline centered on AI-driven drug discovery', 'Expands career pathways into pharma R&D, biotech, clinical research, regulatory science, and precision medicine', 'Strengthens readiness for professional roles in AI-first and technology-enabled pharmaceutical organizations'].map((item, idx) => (
            ...
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated pharmaceutical education and drug discovery', 'Encourages collaboration across Pharmacy, Chemistry, Biology, Computer Science, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Pharmaceutical Science</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered pharmaceutical scientists</p>
...
export default PharmaceuticalScientistsPage;
