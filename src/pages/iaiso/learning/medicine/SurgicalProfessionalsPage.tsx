...
import { Syringe, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const SurgicalProfessionalsPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Surgical Professionals</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">
              Specialization in AI-Assisted Surgery and Surgical Robotics
            </p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">
              Integrating AI into surgical planning, robotic surgery, and operative care for precision interventions
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Surgical Professionals program transforms surgical practice by integrating artificial intelligence into preoperative planning, robotic-assisted surgery, and postoperative care. As surgical technologies advance, professionals must master AI-driven surgical navigation, computer vision systems, and predictive outcome analytics.</p>
                <p className="text-gray-text leading-relaxed">This program bridges traditional surgical expertise with modern AI capabilities, preparing professionals to lead in precision surgery, intelligent operating rooms, and the future of minimally invasive interventions.</p>
              </div>
            </div>
            <div className="space-y-6">
              <h3 className="text-xl font-bold text-foreground flex items-center gap-3"><Cpu className="w-6 h-6 text-purple-600" />Core Surgical Capability</h3>
              <p className="text-gray-text leading-relaxed">This program positions AI as a core surgical capability—embedded within planning, navigation, robotics, and outcomes assessment—while preserving surgical judgment, patient safety, and clinical excellence.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-enhanced surgery, robotic interventions, and precision operative care"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable surgical professionals to design, build, and deploy AI-powered surgical planning and navigation systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in surgical robotics, computer vision, and predictive surgical analytics' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'Surgical Rigor', desc: 'Strengthen understanding of evidence-based, safety-focused, and ethically-sound AI-enabled surgery' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around patient safety, informed consent, and responsible AI in surgery' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in surgery, surgical robotics, and operative technology' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Innovation Readiness', desc: 'Bridge the gap between surgical practice and cutting-edge technology in AI-enabled interventions' } ].map((obj, idx) => (
      ...
      <div ref={cardsRef} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-text dark:text-gray-text max-w-3xl mx-auto">Designed to integrate surgical excellence, global relevance, and real-world practice readiness into modern AI and surgery programs.</p>
          </div>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in surgical AI, robotic surgery, and operative technology</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on surgical excellence, patient safety, and ethical AI deployment in surgery</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Capstone outputs suitable for surgical research, operative protocols, or technology innovations</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Surgery-first architecture preserving operative techniques, patient safety, and clinical excellence</span></li>
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Modular design supports adoption as a specialization track, professional development, or integrated surgery program</span></li>
                </ul>
              </div>
            </div>
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-foreground mb-4">Employability & Surgical Readiness</h3>
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with AI-surgery portfolios and robotic technology experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on surgical depth, technical skills, and ethical professional responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-3xl mx-auto mb-8">Clinical-based learning integrated with surgical simulation labs and robotics training centers</p>
          </div>
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Awarded as <strong>Certified Specialist in AI for Surgical Professionals (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as a medicine–AI integration program</p>
                <p>Validates advanced competence in AI-powered surgery, robotic interventions, and operative technology</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled surgery</p>
              </div>
            </div>
      ...
      <div ref={addToRefs} className="py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80 dark:text-white/80 max-w-2xl mx-auto">Surgical Professionals Academic and Professional Advantage</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Transforms surgical practice into a future-ready discipline centered on AI-enhanced precision care', 'Expands career pathways into surgery, surgical robotics, operative technology, and medical innovation', 'Strengthens readiness for professional roles in AI-first and technology-enabled surgical environments'].map((item, idx) => (
            ...
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated surgical education and operative technology', 'Encourages collaboration across Surgery, Medicine, Biomedical Engineering, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in AI-Enabled Surgery</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-powered surgical professionals</p>
...
export default SurgicalProfessionalsPage;
