...
const SafetyMaintenanceEngineersPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Safety and Maintenance Engineers</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">Specialization in Predictive Safety and Intelligent Asset Management</p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">Integrating AI into safety systems, predictive maintenance, and asset reliability for zero-incident operations</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Safety and Maintenance Engineers program transforms workplace safety and asset management by integrating artificial intelligence into predictive maintenance, hazard detection, and risk assessment. As organizations strive for zero-incident operations, engineers must master AI-driven condition monitoring, predictive analytics, and intelligent safety systems.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical safety and maintenance engineering with modern AI capabilities, preparing engineers to lead in predictive maintenance, digital twins for assets, and proactive safety management.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core engineering capability—embedded within reliability engineering, safety management systems, risk assessment, and asset performance management—while preserving engineering rigor, regulatory compliance, and worker protection.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven predictive maintenance, safety analytics, asset reliability, and zero-incident operations"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable safety and maintenance engineers to design, build, and deploy AI-powered predictive and safety systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in intelligent condition monitoring, hazard prediction, and maintenance analytics' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'System Understanding', desc: 'Strengthen understanding of reliable, compliant, and production-grade AI-enabled safety and maintenance systems' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around worker privacy, safety-critical AI, and responsible engineering' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in predictive maintenance, safety engineering, and asset management' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Industry Readiness', desc: 'Bridge the gap between academic knowledge and industry requirements for AI-enabled safety and maintenance' } ].map((obj, idx) => (
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in safety engineering, reliability-centered maintenance, and AI frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on regulatory compliance, asset reliability, and ethical AI deployment in safety-critical systems</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Engineering-first architecture preserving safety fundamentals, reliability engineering, and risk management</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with intelligent maintenance portfolios and predictive safety project experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on safety and maintenance depth, applied intelligence, and ethical responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Awarded as <strong>Certified Specialist in Intelligent Safety Engineering and Predictive Maintenance (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as an engineering–AI integration program</p>
                <p>Validates advanced competence in AI-powered safety systems, predictive maintenance, and asset reliability</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled safety and maintenance engineering</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Transforms safety and maintenance engineering into a future-ready discipline centered on predictive intelligence', 'Expands career pathways into predictive maintenance, safety analytics, asset management, and reliability engineering', 'Strengthens readiness for global technology roles in AI-first and safety-critical organizations'].map((item, idx) => (
            ...
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated safety and maintenance engineering education', 'Encourages collaboration across Safety Engineering, Maintenance, Reliability, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in Intelligent Safety and Maintenance Engineering</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-enabled safety and maintenance engineers</p>
...
export default SafetyMaintenanceEngineersPage;
