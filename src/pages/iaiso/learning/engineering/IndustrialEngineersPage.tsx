...
import { Factory, Brain, Cpu, Shield, Globe, GraduationCap, Award, Building2, Users, Layers, Zap } from 'lucide-react';

gsap.registerPlugin(ScrollTrigger);

const IndustrialEngineersPage = () => {
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground mb-6 leading-tight">
              AI for <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Industrial Engineers</span>
            </h1>
            <p className="text-xl text-gray-text font-medium mb-4">Specialization in Intelligent Manufacturing and Operations Optimization</p>
            <p className="text-lg text-gray-text max-w-3xl mx-auto">Integrating AI into manufacturing processes, supply chain, and operations for Industry 4.0 transformation</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="relative bg-secondary/30 rounded-2xl p-8 shadow-xl border border-border">
                ...
                <p className="text-gray-text leading-relaxed mb-6">The AI for Industrial Engineers program transforms manufacturing and operations by integrating artificial intelligence into production systems, supply chains, and quality management. As Industry 4.0 reshapes global manufacturing, engineers must master AI-driven process optimization, predictive maintenance, and intelligent automation.</p>
                <p className="text-gray-text leading-relaxed">This program bridges classical industrial engineering with modern AI capabilities, preparing engineers to lead in smart manufacturing, digital twins, and autonomous operations.</p>
              </div>
            </div>
            <div className="space-y-6">
              ...
              <p className="text-gray-text leading-relaxed">This program positions AI as a core engineering capability—embedded within process design, operations research, ergonomics, and systems optimization—while preserving engineering rigor, efficiency, and continuous improvement.</p>
              <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border-l-4 border-blue-500">
                <p className="text-gray-text italic">"Preparing graduates for advanced roles in AI-driven manufacturing, supply chain optimization, quality systems, and Industry 4.0 transformation"</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={addToRefs} className="overflow-hidden relative py-16 lg:py-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[ { icon: <Layers className="w-8 h-8 text-blue-600" />, title: 'Design & Deploy', desc: 'Enable industrial engineers to design, build, and deploy AI-powered manufacturing and operations systems' }, { icon: <Brain className="w-8 h-8 text-purple-600" />, title: 'Develop Competencies', desc: 'Develop competencies in intelligent process optimization, predictive maintenance, and supply chain analytics' }, { icon: <Shield className="w-8 h-8 text-green-600" />, title: 'System Understanding', desc: 'Strengthen understanding of efficient, agile, and production-grade AI-enabled operations' }, { icon: <Award className="w-8 h-8 text-amber-600" />, title: 'Ethical Awareness', desc: 'Instil ethical awareness around workforce impact, data privacy, and responsible automation' }, { icon: <Globe className="w-8 h-8 text-indigo-600" />, title: 'Career Preparation', desc: 'Prepare graduates for advanced roles in smart manufacturing, operations research, and Industry 4.0' }, { icon: <Zap className="w-8 h-8 text-rose-600" />, title: 'Industry Readiness', desc: 'Bridge the gap between academic knowledge and industry requirements for AI-enabled industrial engineering' } ].map((obj, idx) => (
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Aligned with global best practices in Industry 4.0, smart manufacturing, and operations frameworks</span></li>
                  <li className="flex items-start gap-2"><span className="text-blue-600 mt-1">•</span><span>Emphasis on operational excellence, sustainability, and ethical AI deployment</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-purple-600 mt-1">•</span><span>Engineering-first architecture preserving industrial fundamentals, process design, and systems thinking</span></li>
            ...
            <div className="value-card group bg-secondary/30 rounded-2xl overflow-hidden shadow-lg border border-border transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
              ...
              <div className="p-6">
                ...
                <ul className="space-y-3 text-gray-text text-sm">
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Graduates complete the program with intelligent operations portfolios and Industry 4.0 project experience</span></li>
                  <li className="flex items-start gap-2"><span className="text-emerald-600 mt-1">•</span><span>Balanced emphasis on industrial engineering depth, applied intelligence, and ethical responsibility</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white/80">
                <p>Awarded as <strong>Certified Specialist in Intelligent Industrial Engineering and Manufacturing AI (IAISO)</strong></p>
                <p>Certified by the International Federation for Artificial Intelligence (IAISO) as an engineering–AI integration program</p>
                <p>Validates advanced competence in AI-powered operations, supply chain optimization, and Industry 4.0</p>
                <p>Confirms ethical, technical, and professional responsibility in AI-enabled industrial engineering</p>
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Transforms industrial engineering into a future-ready discipline centered on intelligent operations', 'Expands career pathways into smart manufacturing, supply chain, quality engineering, and Industry 4.0', 'Strengthens readiness for global technology roles in AI-first and automation-driven organizations'].map((item, idx) => (
            ...
            <div className="bg-black/35 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/10">
              ...
              <ul className="space-y-4">
                {['Positions the university as a leader in AI-integrated industrial engineering education', 'Encourages collaboration across Industrial Engineering, Operations, Supply Chain, and AI departments'].map((item, idx) => (
      ...
      <div ref={addToRefs} className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Begin Your Journey in Intelligent Industrial Engineering</h2>
          <p className="text-xl text-white/90 mb-8">Join the next generation of AI-enabled industrial engineers</p>
...
export default IndustrialEngineersPage;
